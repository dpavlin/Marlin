...
#define STRING_CONFIG_H_AUTHOR "dpavlin@rot13.org" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 62.11, 64.67, 2272.72, 536 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 60, 60, 2, 14 }
...
// dpavlin -- my probe is on the left side of nozzle

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 25 // dpavlin -- this enables us to miss claps for heatbed+glass
...
//
#define Z_SAFE_HOMING // dpavlin - we need to probe z in the middle or we will miss glass and fail
 ...
 */
//#define SDSUPPORT
/* according to pins_PRINTRBOARD.h this will also move Y STOP to E STOP */
